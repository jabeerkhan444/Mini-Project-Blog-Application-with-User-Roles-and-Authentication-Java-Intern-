<%@ page import="com.model.Post,java.util.List" %>
...
<div class="container">
    <% 
        ...
        for (Post post : posts) { 
    %>
        <a href="updatePost.jsp?id=<%= post.getId() %>" class="item">
            <img src="<%= request.getContextPath() + "/uploads/" + post.getFilePath() %>" alt="<%= post.getTitle() %>">
